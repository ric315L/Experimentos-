...
def main():
    ...
    if str(modelos)=='all':
        ...
        print('Termina procesamiento de datos')
        print('*'*30)
    bests={'C': 0.1, 'fit_intercept': True, 'max_iter': 100, 'penalty': 'l1', 'solver': 'liblinear', 'tol': 0.0001,'max_iter':3000,'random_state':0}
    modelo_lr = LogisticRegression(**bests)
    ...
    with open('./LR_HP_S1.txt', 'a') as archivo:
