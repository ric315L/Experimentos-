...
def main():
    ...
    modelo_lr = LogisticRegression(random_state=0, max_iter=4000)
    ...
    grid_search = GridSearchCV(modelo_lr, param_grid, cv=5, scoring='f1_macro', n_jobs=1)
    ...
    with open('GS_model2_S1.txt', 'a') as file:
