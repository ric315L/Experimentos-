...
def main():
  ...
  #models=[
   ...
   # "vg055/xlm-roberta-base-finetuned-IberAuTexTification2024-7030-task1-v2",
   # "vg055/xlm-roberta-base-finetuned-IberAuTexTification2024-7030-4epo-task1-v2",
   # "vg055/bert-base-multilingual-cased-finetuned-IberAuTexTification2024-7030-4epo-task1-v2", 
   # "vg055/multilingual-e5-large-finetuned-IberAuTexTification2024-7030-4epo-task1-v2"
   # ]
  ...
  #models=["andricValdez/xlm-roberta-base-finetuned-autext24-subtask2"]
